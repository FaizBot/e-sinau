...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    {{-- @if ($teacher && $teacher->type === 'classroomTeacher')
      <li class="menu-item {{ request()->routeIs(
          'teacher.classes.index',
          'teacher.classes.courses.index',
          'teacher.classes.plot',
          'teacher.courses.tasks.index',
          'teacher.courses.materials.*',
          'teacher.assignment.*'
      ) ? 'active' : '' }}">
    ...
    <li class="menu-item {{ request()->routeIs('teacher.courses.manage', 'teacher.courses.tasks.index',
          'teacher.courses.materials.*',
          'teacher.assignment.*'
      ) ? 'active' : '' }}">
      <a href="{{ route('teacher.courses.manage') }}" class="menu-link">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
          <li class="px-3 py-2">
            ...
            <small class="text-muted">{{ Auth::user()->role ?? 'Teacher' }}</small>
          </li>
