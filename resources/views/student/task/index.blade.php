    ...
    <div class="task-header mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="d-flex gap-2 mt-2 mt-md-0">
                <a href="{{ route('student.classes.courses.index', $class->id) }}" class="btn btn-outline-secondary btn-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex gap-1">
                                        <a href="{{ route('student.courses.materials.preview', [$class->id, $course->id, $material->id]) }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        ...
                                        @if (!$result)
                                            <a href="{{ route('student.assignment.show', [$class->id, $course->id, $assignment->id]) }}"
                                        ...
                                        @elseif ($result->status === 'completed')
                                            <a href="{{ route('student.assignment.result', [$class->id, $course->id, $assignment->id]) }}"
