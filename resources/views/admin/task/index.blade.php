    ...
    <div class="task-header mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="d-flex gap-2 mt-2 mt-md-0">
                <a href="{{ route('admin.classes.courses.index', $class->id) }}" class="btn btn-outline-secondary btn-sm">
                    <i class="bx bx-arrow-back"></i>
                    Kembali
                </a>

                <a href="{{ route('admin.courses.materials.create', [$class->id, $course->id]) }}" class="btn btn-primary btn-sm">
                    <i class="bx bx-book-add"></i>
                    Tambah Materi
                </a>

                <a href="{{ route('admin.assignment.create', [$class->id, $course->id]) }}" class="btn btn-warning btn-sm text-dark">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex gap-1">
                                        <a href="{{ route('admin.courses.materials.edit', [$class->id, $course->id, $material->id]) }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        <form
                                                            method="POST"
                                                            action="{{ route('admin.courses.materials.destroy', [$class->id, $course->id, $material->id]) }}">
                                                            @csrf
                                                            @method('DELETE')
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        <form
                                                            method="POST"
                                                            action="{{ route('admin.materials.publish', [$class->id, $course->id, $material->id]) }}"
                                                        >
                                                            @csrf
                                                            @method('PATCH')
                                        ...
                                        <a href="{{ route('admin.courses.materials.preview', [$class->id, $course->id, $material->id]) }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex gap-1">
                                        ...
                                        <div class="modal fade" id="deleteAssignment{{ $assignment->id }}" tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        <form method="POST" action="{{ route('admin.assignment.destroy', [
                                                            'class' => $class->id,
                                                            'course' => $course->id,
                                                            'assignment' => $assignment->id
                                                        ]) }}">
                                        ...
                                        <div class="modal fade" id="publishAssignment{{ $assignment->id }}" tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        <form method="POST"
                                                            action="{{ route('admin.assignment.publish', [$class->id, $course->id, $assignment->id]) }}">
                                                            @csrf
                                                            @method('PATCH')
                                        ...
                                        {{-- PREVIEW --}}
                                        <a href="{{ route('admin.assignment.show', [$class->id, $course->id, $assignment->id]) }}" class="btn btn-sm btn-outline-info">
                                            <i class="bx bx-show"></i>
                                        </a>
