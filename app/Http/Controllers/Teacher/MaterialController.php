...
class MaterialController extends Controller
{
    ...
    {
        $title = 'Tambah Materi';
        return view('teacher.task.materials.create', compact('class', 'course', 'title'));
    }
    ...
    public function edit(SchoolClass $class, Course $course, Material $material)
    {
        ...
        return view('teacher.task.materials.edit', compact(
            'title',
            'class',
            'course',
            'material'
    ...
    public function update(Request $request, $classId, $courseId, $materialId)
    {
        ...
        return redirect()
            ->route('teacher.courses.tasks.index', [$classId, $courseId])
    ...
    public function preview(SchoolClass $class, Course $course, Material $material)
    {
        ...
        return view('teacher.task.materials.preview', compact(
            'title',
            'class',
            'course',
            'material'
