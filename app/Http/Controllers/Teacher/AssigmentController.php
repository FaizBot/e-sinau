...
class AssignmentController extends Controller
{
    ...
    {
        $title = 'Tambah Tugas';
        return view('teacher.task.assignments.create', compact('course', 'class', 'title'));
    }
    ...
    public function store(Request $request, SchoolClass $class, Course $course)
    {
        ...
        try {
            ...
            return redirect()
                ->route('teacher.courses.tasks.index', [$class->id, $course->id])
    ...
    public function show(SchoolClass $class, Course $course, Assignment $assignment)
    {
        ...
        return view('teacher.task.assignments.show', compact(
            'class',
            'course',
            'assignment',
            'isTeacher'
    ...
    public function progress(SchoolClass $class, Course $course, Assignment $assignment)
    {
        ...
        return view('teacher.task.assignments.progress', compact(
            'title',
            'class',
            'course',
            'assignment',
    ...
    public function showAssignmentStudent(SchoolClass $class, Course $course, Assignment $assignment, $nis)
    {
        ...
        return view('teacher.task.assignments.review', compact(
            'title',
            'class',
            'course',
            'assignment',
    ...
    return view('teacher.task.assignments.grade', compact(
        'title',
        'class',
        'course',
        'assignment',
    ...
    return redirect()
        ->route('teacher.assignment.progress', [
            'class'      => $class->id,
            'course'     => $course->id,
